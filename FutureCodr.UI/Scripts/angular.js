...
function jqLitePatchJQueryRemove(name, dispatchThis, filterElems, getterIfNoArguments) {
  ...
  function removePatch(param) {
    // jshint -W040
    var list = filterElems && param ? [filter(param)] : [this],
  ...
  JQLite.prototype[name] = function(arg1, arg2) {
    ...
    if (fn !== jqLiteEmpty &&
      ...
      if (isObject(arg1)) {
        ...
        var jj = (value === undefined) ? Math.min(length, 1) : length;
        for (var j = 0; j < jj; j++) {
...
var $AnimateProvider = ['$provide', function($provide) {
  ...
  $get = ['$timeout', '$$asyncCallback', function($timeout, $$asyncCallback) {
  ...
  $get = [
    ...
    Attributes.prototype = {
      ...
      $set: function(key, value, writeAttr, attrName) {
        ...
        var booleanKey = getBooleanAttrName($$element[0], key),
            normalizedVal,
            nodeName;
...
function $HttpProvider() {
   ...
   */
  var responseInterceptorFactories = responseInterceptors = [];
...
LocationHashbangInHtml5Url.prototype =
  ...
  url: function(url, replace) {
    ...
    if (match[2] || match[1]) search(match[3] || '');
...
function $LocationProvider(){
  ...
  $get = ['$rootScope', '$browser', '$sniffer', '$rootElement',
...
Lexer.prototype = {
  ...
  readIdent: function() {
    ...
    if (OPERATORS.hasOwnProperty(ident)) {
      ...
      var getter = getterFn(ident, options, text);
...
Parser.prototype = {
  ...
  parse: function (text, json) {
    ...
    var value = json ? primary() : statements();
  ...
  unary: function() {
    ...
    if (expect('+')) {
      ...
      return binaryFn(Parser.ZERO, token.fn, unary());
    } else if ((token = expect('!'))) {
  ...
  fieldAccess: function(object) {
    ...
    var getter = getterFn(field, options, text);
...
function $ParseProvider() {
   ...
   *                         setter.
   */
 logPromiseWarnings = function(value) {
    if (isDefined(value)) {
  ...
  $get = ['$filter', '$sniffer', '$log', function($filter, $sniffer, $log) {
  ...
  $get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    Scope.prototype = {
      ...
      $watchCollection: function(obj, listener) {
        ...
        return $watch($watchCollectionWatch, $watchCollectionAction);
      },
      ...
      $destroy: function() {
        ...
        forEach($$listenerCount, bind(null, decrementListenerCount, this));
...
function $SceProvider() {
  ...
  $get = ['$parse', '$sniffer', '$sceDelegate', function(
...
function $TimeoutProvider() {
  $get = ['$rootScope', '$browser', '$q', '$exceptionHandler',
...
var NgModelController = ['$scope', '$exceptionHandler', '$attrs', '$element', '$parse', '$animate',
  ...
  var parentForm = $element.inheritedData('$formController') || nullFormCtrl,
      invalidCount = 0, // used to easily determine if we are valid
      $error = $error = {}; // keep invalid keys here
  ...
  $setViewValue = function(value) {
    ...
    if ($modelValue !== value) {
      ...
      forEach($viewChangeListeners, function(listener) {
        try {
          listener();
        } catch(e) {
          $exceptionHandler(e);
